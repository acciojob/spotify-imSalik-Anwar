...
public class SpotifyController {
    ...
    public String createArtist(@RequestParam("name") String name){
    ...
    public String createAlbum(@RequestParam("title") String title, @RequestParam("artist") String artistName){
    ...
    public String findPlaylist(@RequestParam("mobile") String mobile, @RequestParam("playlist") String playlistTitle) throws Exception{
    ...
    public String likeSong(@RequestParam("mobile") String mobile, @RequestParam("title") String songTitle) throws Exception{
